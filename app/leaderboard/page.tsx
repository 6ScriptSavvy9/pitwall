...
import { currentUser, globalLeaderboard, grandsPrix } from '@/lib/mock-data'

type Tab = 'global' | 'league'
type Filter = 'season' | string // 'season' ou un GP id
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-text-secondary mt-1">
              Saison 2025 • {globalLeaderboard.length} participants
            </p>
          </div>
